...
colnames(train_full_level1) <- level1_symptoms(colnames(train_full_level1))

#level 2 combination copy
train_level2 <- train_full
colnames(train_level2) <- level2_symptoms(colnames(train_level2))

#level 3 combination copy
train_level3 <- train_full
colnames(train_level3) <- level3_symptoms(colnames(train_level3))
