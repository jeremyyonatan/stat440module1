...
final_level3 <- select(final_level3,c(clean_age,sex, city, province, country, V1, confirmed, duration, gi, respiratory, fever, weakness))
...
final_test3 <- select(final_test3,c(clean_age, sex, city, province, country, V1, confirmed, gi, respiratory, fever, weakness))
```
...
ggplot(final_level3, aes(duration, fill=weakness)) +
    geom_histogram(position = "stack", binwidth=2)
ggplot(final_level3, aes(duration, fill=sorethroat)) +
    geom_histogram(position = "stack", binwidth=2)
ggplot(final_level3, aes(duration, fill=headache)) +
    geom_histogram(position = "stack", binwidth=2)
ggplot(final_level3, aes(duration, fill=runnynose)) +
    geom_histogram(position = "stack", binwidth=2)
ggplot(final_level3, aes(duration, fill=conjunctivitis)) +
    geom_histogram(position = "stack", binwidth=2)

```
```{r}
ggplot(final_level3, aes(clean_age)) +
