...
final_test3 <- select(final_test3,c(clean_age, country, V1, confirmed, gi, respiratory, fever, weakness))
```
...
ggplot(final_level3, aes(duration, fill=weakness)) +
    geom_histogram(position = "stack", binwidth=2)
ggplot(final_level3, aes(duration, fill = sex)) +
    geom_histogram(binwidth=2)
ggplot(final_level3, aes(duration, fill = city)) +
    geom_histogram(binwidth=2)
ggplot(final_level3, aes(duration, fill = country)) +
    geom_histogram(binwidth=2)
ggplot(final_level3, aes(duration, fill = province)) +
    geom_histogram(binwidth=2)
