...
final_level3 <- final_level3[c[clean_age, sex, city, province, country, V1, confirmed, duration, gi, respiratory, fever, weakness]]
...
final_test3 <- final_test3[c[clean_age, sex, city, province, country, V1, confirmed, duration, gi, respiratory, fever, weakness]]
```
